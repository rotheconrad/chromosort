...
from . import cut, fix_contigs, plot, reference_order, scaffold
...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(
        prog="chromo",
        description="Reference-order, fix, cut, scaffold, and plot genome assembly contigs.",
    )
    parser.add_argument(
        "command",
        nargs="?",
        choices=["sort", "fix", "cut", "scaffold", "plot"],
